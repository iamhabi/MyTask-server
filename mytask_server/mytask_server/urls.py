...
from accounts.views import CustomTokenObtainPairView, RegisterView, DeleteView, ChangePasswordView, UpdateView
...
urlpatterns = [
    ...
    path('api/account/update/<str:pk>', UpdateView.as_view(), name='update_user'),
